...
| Name  | Type   | Required | Description                                                                                                                                                    |
| ----- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type  | string | No       | Well-known input type or custom identifier. Well-known types: 'text' (free-form text like engraving), 'selection' (choice from options, including time slots). |
| value | any    | No       | The input value. For 'selection': the id of the selected option from input_schema.options. For 'text': the entered string.                                     |
...
#### Ancillary Request Item

| Name     | Type    | Required | Description                                                                                                           |
| -------- | ------- | -------- | --------------------------------------------------------------------------------------------------------------------- |
| item     | object  | **Yes**  | Item reference for the ancillary.                                                                                     |
| for      | string  | No       | Line item ID this ancillary relates to. Required for relational ancillaries (e.g., insurance for a specific product). |
| quantity | integer | **Yes**  | Quantity of the ancillary. For relational ancillaries, MUST equal the quantity of the related line item.              |
| input    | object  | No       | Input data for ancillaries that require buyer input. Required when the suggestion has requires_input: true.           |
...
| ancillaries  | object        | No       | Ancillaries input and suggestions/applied output.                                                                                                                                                                                                               |
